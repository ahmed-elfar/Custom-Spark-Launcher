...
class ChildProcAppHandle extends AbstractAppHandle {
   ...
   * exception, otherwise returns a {@link Optional#}
   */
  @Override
  ...
  void setChildProc(Process childProc, String loggerName, InputStream logStream, boolean onlyStreams) {
    this.childProc = childProc;
    if (logStream != null && !onlyStreams) {
  ...
  public InputStream getInputStream(){
    return childProc.getInputStream();
  }

  public InputStream getErrorStream(){
    return childProc.getErrorStream();
  }

  public OutputStream getOutputStream(){
    return childProc.getOutputStream();
  }
}
