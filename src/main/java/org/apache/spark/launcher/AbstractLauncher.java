...
import static org.apache.spark.launcher.CommandBuilderUtils.checkNotNull;
...
public abstract class AbstractLauncher<T extends AbstractLauncher<T>> {
   ...
   * a child process, {@link org.apache.spark.launcher.SparkAppHandle#kill()} can still be used to kill the child process.
   *
   * @since 1.6.0
   * @param listeners Listeners to add to the handle before the app is launched.
   * @return A handle for the launched application.
   */
  public abstract org.apache.spark.launcher.SparkAppHandle startApplication(SparkAppHandle.Listener... listeners)
    throws IOException;
